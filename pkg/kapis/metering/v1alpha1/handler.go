...
func newHandler(k kubernetes.Interface, m monitoring.Interface, f informers.InformerFactory, o openpitrix.Client) meterHandler {
	return monitorhle.NewHandler(k, m, f, o)
}
