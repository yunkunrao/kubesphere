...
func AddToContainer(c *restful.Container, k8sClient kubernetes.Interface, meteringClient monitoring.Interface, factory informers.InformerFactory, opClient openpitrix.Client) error {
	ws := runtime.NewWebService(GroupVersion)

	h := newHandler(k8sClient, meteringClient, factory, opClient)
